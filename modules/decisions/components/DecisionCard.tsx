...
> = {
  調價: { label: "產業雷達", href: "/demo/radar", icon: Radar },
  成本: { label: "產業雷達", href: "/demo/radar", icon: Radar },
  平台費: { label: "產業雷達", href: "/demo/radar", icon: Radar },
  補貨: { label: "庫存預警", href: "/demo/inventory", icon: Boxes },
  備料不足: { label: "庫存預警", href: "/demo/inventory", icon: Boxes },
  滯銷: { label: "庫存預警", href: "/demo/inventory", icon: Boxes },
  效期警示: { label: "效期監控", href: "/demo/inventory", icon: Boxes },
  工單延遲: { label: "生產排程", href: "/demo/orders", icon: Factory },
  排程: { label: "生產排程", href: "/demo/orders", icon: Factory },
  ...
  選品: { label: "選品雷達", href: "/demo/picking", icon: Radar },
  廣告: { label: "廣告成效", icon: Radar },
  物流: { label: "物流監控", href: "/demo/orders", icon: Factory },
  設備: { label: "設備監控", icon: ShieldCheck },
  供應: { label: "供應鏈監控", href: "/demo/inventory", icon: Boxes },
  ...
  競品: { label: "產業雷達", href: "/demo/radar", icon: Radar },
  ...
  天災: { label: "產業雷達", href: "/demo/radar", icon: Radar },
};
